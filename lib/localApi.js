...
exports.start = function () {
    console.log('#########################'.red);
    console.log('LocalAPI by IsaaCloud.com'.red);
    console.log('#########################'.red);
    console.log('[localapi] Start'.cyan);
    console.log('[localapi] Generate templates'.cyan);

    templatesManager.run().then(function () {

        console.log('[localapi] Start loading raml'.cyan);
